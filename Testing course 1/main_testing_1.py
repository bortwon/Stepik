...
# - Энциклопедия джуна
# https://github.com/Kakha-Khinikadze/Links-QA/blob/master/Links.md

# - Огромный список ресурсов, который будет интересен джунам и опытным спецам. Гайды, чек-листы — чего только нет, если
# порыться. Полезного достаточно. Советую присмотреться к тренажёрам.
# https://artsiomrusau.com/articles/

# - Шпаргалки по SQL —все под рукой, что может пригодиться в работе с реляционными базами данных: ключевые слова,
# комментарии, операторы, джойны.
# https://tproger.ru/articles/shpargalki-po-sql/

# - Джаст фо фан — задачки на логику. Мозги размять, а может и на собесе что-нибудь попадётся.
# https://telegra.ph/Samaya-interesnaya-chast-sobesedovaniya-testirovshchika-zadachi-na-logiku-07-13
